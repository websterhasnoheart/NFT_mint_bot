...
from config.settings import w3, PRIVATE_KEY, logger, LOGGING


class LocalAccountExt(LocalAccount):
    """Overwrite eth_account.LocalAccount to add custom methods.
    """
...
class AccountExt(Account):
    """Overwrite eth_account.Account to add custom methods.
    """
