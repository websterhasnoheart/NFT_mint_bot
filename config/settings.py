...
with open('config/settings.json') as f:
    # Import config info, please keep these info in a separate file
    ...
    MINT_DATE = SETTINGS['MINT_DATE']

with open('config/private_keys.json') as f:
    SECRETS = json.load(f)
...
parser.epilog = 'Example: python goMint.py -multi'
